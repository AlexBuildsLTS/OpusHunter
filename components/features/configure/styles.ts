...
export const st = StyleSheet.create({
    ...
    tabBar: {
        flexDirection: 'row', marginBottom: 14, backgroundColor: `${C.text}07`,
        borderRadius: 14, borderWidth: 1, borderColor: C.border, padding: 3, gap: 3,
        maxWidth: 600, width: '100%', alignSelf: 'center' as any,
    },
    tabBtn: {
        flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
        gap: 7, paddingVertical: 12, borderRadius: 12, borderWidth: 2, borderColor: 'transparent',
    },
    tabBtnActive: { borderColor: `${C.cyan}28`, backgroundColor: `${C.cyan}0C` },
    tabBtnText: { fontSize: 12, fontWeight: '800', letterSpacing: 0.5 },

    tabScroll: { paddingTop: 8, paddingBottom: 120, maxWidth: 1100, width: '100%', alignSelf: 'center' as any, gap: 0 },

    scraperCard: {
        flexDirection: 'row', alignItems: 'center', padding: 16, borderRadius: 18, borderWidth: 1,
        borderColor: `${C.cyan}28`, backgroundColor: `${C.cyan}07`, marginBottom: 20, gap: 14,
    },
    scraperCardLeft: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 12 },
    scraperPulse: {
        width: 44, height: 44, borderRadius: 13, backgroundColor: `${C.cyan}12`, borderWidth: 1,
        borderColor: `${C.cyan}30`, alignItems: 'center', justifyContent: 'center',
    },
    ...
    scrapeBtn: {
        ...
        borderRadius: 12, borderWidth: 1, borderColor: `${C.cyan}30`, backgroundColor: `${C.cyan}08`,
    },
    scrapeBtnText: { fontSize: 10, fontWeight: '800', color: C.cyan, letterSpacing: 1.5 },

    section: {
        marginBottom: 16, borderRadius: 18, borderWidth: 1, borderColor: C.border,
        backgroundColor: 'rgba(20,14,32,0.68)', padding: 16, maxWidth: 600, width: '100%', alignSelf: 'center' as any,
    },
    sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 16 },
    sectionIconBox: {
        width: 30, height: 30, borderRadius: 9, backgroundColor: `${C.cyan}10`, borderWidth: 1,
        borderColor: `${C.cyan}20`, alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 1,
    },
    ...
    customLocRow: { flexDirection: 'row', gap: 8, marginTop: 12, zIndex: 50 },
    customLocInput: {
        flex: 1, height: 42, borderRadius: 10, borderWidth: 1, borderColor: C.border,
        backgroundColor: 'rgba(255,255,255,0.03)', paddingHorizontal: 12, color: C.text, fontSize: 13,
    },
    customLocBtn: { width: 42, height: 42, borderRadius: 10, backgroundColor: C.cyan, alignItems: 'center', justifyContent: 'center' },

    remoteRow: { flexDirection: 'row', gap: 8, flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center' },
    remoteBtn: {
    ...
    salaryRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, justifyContent: 'center', alignItems: 'center' },

    boardGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, justifyContent: 'center', alignItems: 'center' },
    boardCard: {
        flex: 1, minWidth: '30%', aspectRatio: 1.2, borderRadius: 14, borderWidth: 1,
    ...
    ruleCard: {
        flexDirection: 'row', alignItems: 'center', padding: 13, borderRadius: 16, borderWidth: 1,
    ...
    ruleMetaSub: { fontSize: 10, color: 'rgba(216,228,236,0.22)', flex: 1 },
    ...
    kwChip: {
        ...
        borderColor: `${C.cyan}30`, backgroundColor: `${C.cyan}0A`,
    },
    kwChipText: { fontSize: 10, color: C.cyan, fontWeight: '700' },

    emptyState: { alignItems: 'center', paddingVertical: 70, paddingHorizontal: 32 },
    emptyIcon: {
        width: 72, height: 72, borderRadius: 36, borderWidth: 1, borderColor: `${C.purple}40`,
    ...
    emptyAddBtn: {
        flexDirection: 'row', alignItems: 'center', gap: 7, paddingHorizontal: 22, paddingVertical: 11,
        borderRadius: 12, borderWidth: 1, borderColor: `${C.cyan}40`, backgroundColor: `${C.cyan}0D`,
    },
    emptyAddText: { color: C.cyan, fontSize: 13, fontWeight: '700' },

    modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.75)', justifyContent: 'flex-end' },
    modalCard: {
        backgroundColor: '#050C12', borderTopLeftRadius: 28, borderTopRightRadius: 28,
        borderWidth: 1, borderColor: 'rgba(0,212,255,0.18)', maxHeight: '92%', overflow: 'hidden',
    },
    modalHeader: {
        flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
        padding: 20, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)', backgroundColor: 'rgba(0,0,0,0.3)'
    },
    modalTitle: { fontSize: 16, fontWeight: '800', color: C.text },
    modalFooter: { padding: 20, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.05)', backgroundColor: 'rgba(0,0,0,0.2)' },
    ...
    confirmCard: {
        position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: '#0B1520',
        borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 28, borderWidth: 1, borderColor: 'rgba(232,67,106,0.15)',
    },
