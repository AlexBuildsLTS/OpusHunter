 ...
 * title/skill taxonomy with LIVE type-ahead filtering. Previously, typing
 * something like "Java" into the free-text field just added the literal
 * characters "Java" as a keyword with no suggestions at all — there was no
 * path to "Java Backend Developer" or "Full Stack Java Developer" unless
 * the user already knew to type that exact phrase. Now: as soon as 2+
 * characters are typed, a dropdown of matching taxonomy entries appears
 * (prefix matches ranked above substring matches), the same way
 * LocationAutocomplete already works for cities. Nothing already saved as a
 * keyword changes shape — this only changes how new ones get suggested.
 *
...
const JOB_TITLE_TAXONOMY = [
    ...
    'Principal Engineer', 'Junior Software Engineer', 'Software Developer',
    'Applications Developer', 'Systems Engineer', 'Platform Engineer',

    // Java
    'Java Developer', 'Junior Java Developer', 'Senior Java Developer',
    'Java Backend Developer', 'Full Stack Java Developer', 'Java Software Engineer',
    'Java Spring Developer', 'Java Microservices Engineer',

    // Full stack / frontend / backend
    'Full Stack Developer', 'Full Stack Engineer', 'Frontend Developer',
    'Frontend Engineer', 'Backend Developer', 'Backend Engineer',
    'React Developer', 'React Native Developer', 'Vue Developer', 'Angular Developer',
    'Node.js Developer', 'Python Developer', 'Django Developer', 'PHP Developer',
    'Ruby on Rails Developer', 'Go Developer', 'Rust Developer', '.NET Developer',
    'C# Developer', 'C++ Developer',

    // Mobile
    'Mobile Developer', 'iOS Developer', 'Android Developer',
    'React Native Engineer', 'Flutter Developer', 'Swift Developer', 'Kotlin Developer',

    // Data / ML
    'Data Analyst', 'Data Engineer', 'Data Scientist', 'Machine Learning Engineer',
    'ML Engineer', 'AI Engineer', 'Analytics Engineer', 'Business Intelligence Analyst',
    'Data Architect',

    // DevOps / infra / cloud
    'DevOps Engineer', 'Site Reliability Engineer', 'SRE', 'Cloud Engineer',
    'Infrastructure Engineer', 'Platform Reliability Engineer', 'AWS Engineer',
    'Kubernetes Engineer', 'Security Engineer', 'Cybersecurity Analyst',
    ...
    'Technical Product Manager', 'Product Owner', 'UX Designer', 'UI Designer',
    'Product Designer', 'UX Researcher', 'Design Lead',

    // Management / leadership
    'Engineering Manager', 'Technical Lead', 'Tech Lead', 'CTO', 'VP of Engineering',
    'Director of Engineering', 'Head of Product',

    // Other common searches
    'Solutions Architect', 'Technical Writer', 'Scrum Master', 'Project Manager',
    'Business Analyst', 'Sales Engineer', 'Customer Success Engineer',
    'Support Engineer', 'IT Support Specialist', 'Network Engineer',
    'Database Administrator', 'ERP Consultant', 'Salesforce Developer',
    'WordPress Developer', 'Shopify Developer', 'Blockchain Developer',
...
export function KeywordTagInput({ value, onChange }: KeywordTagInputProps) {
    ...
    const showDropdown = focused && custom.trim().length >= 2 && filteredSuggestions.length > 0;
    ...
    return (
        <View>
            ...
            <View style={{ position: 'relative' }}>
                ...
                >
                    ...
                    <TextInput
                        ...
                        placeholder="Type a role or skill — Java, Product Manager, React..."
                ...
                {showDropdown && (
                    <View
                        style={{
                            ...
                            backgroundColor: '#0D0918', borderWidth: 1, borderColor: C.border,
                            borderRadius: 14, maxHeight: 220, overflow: 'hidden',
                        }}
                    >
            ...
            {!showDropdown && (
                <>
                    <Text className="text-[10px] font-bold uppercase tracking-widest mb-2 mt-3" style={{ color: C.sub }}>
                        Popular
                    </Text>
